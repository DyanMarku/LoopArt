				...
				<section class="content">
					<div class="row">
						<div class="col-sm-12">
							...
							?>
							<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="border-radius: 15px; border-color:antiquewhite; border-style: solid; border-width: thick; margin-top: 20px">
