          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header with-border">
                <a href="#addnew" data-toggle="modal" id="add" data-id="<?php echo $user['id']; ?>" class="btn btn-primary btn-sm btn-flat" style="background-color: #EE4D2D; border-color:#EE4D2D; "><i class="fa fa-plus"></i> New</a>
                <a href="users.php" class="btn btn-sm btn-primary btn-flat" style="background-color: #EE4D2D; border-color:#EE4D2D; "><i class="fa fa-arrow-left"></i> Users</a>
              </div>
              <div class="box-body">
